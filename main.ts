...
// TASK 3
let personName: string = "Dua Majeed";
in lowercase
...
//TASK 11
let names : string []= ["dua","aqsa","noor","bilal","hassan"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
//TASK 12
let names : string []= ["dua","aqsa","noor","bilal","hassan"];
let message : string = "Would you like to eat pizza?"
...
//TASK 13
let transportation: string [] = ["Honda Motorcycle","Civic","Vitz","Toyota Revo"];
transportation.map((items) => console.log(`I would like to own a ${items}`));

//TASK 14
let guestArr : string []= ["dua","aqsa","noor"];
guestArr.map((items) => (console.log(`Dear ${items} , you are invited to the lunch`)));

//TASK 15
let guestArr : string[] = ["dua","aqsa","noor","bilal"];
...
guestArr.map((items) =>
console.log(`Dear ${items} , you are invited o the dinner.`))

//TASK 16
let guestArr : string[] = ["hassan","aqsa","noor","bilal"];
...
// // PART 2 Beginning
let guestBeg : string = "inaya"
guestArr.unshift(guestBeg);
console.log(guestArr);
// PART 3 Middle
let middleGuest : string = "fajur"
...
// //PART 5 
guestArr.map((items) => 
console.log(`Dear ${items} , you are invited to the huge dinner party`));

//TASK 17
// // Initial list of guests
 let guests : string[] = ["fajur","aqsa","noor","bilal","hassan"];
...
// //TASK 19
let invitations : string [] = ["fajur" , "aqsa"]
...
// //TASK 21
let person: {name: string , fname: string , age: number} = {name :"Dua Majeed" , fname:"female", age:19}
console.log(person)

// // TASK 22
const days : string[] = ["Sunday","Monday","Tuesday","Wednesday","Thursady","Friday","Saturday"]
...
let name_1 : string = "Dua"
let name_2 : string = "Dua Majeed"
let name_3 : string = "Miss Dua Majeed"
if (name_1 == name_3){
...
let aliens_color : string = "yellow"
if (aliens_color == "green"){
    console.log("player just earned 5 points")
}
else if(aliens_color == "yellow"){
...
// TASK 30
let users : string [] = ["admin","eric","dua","fajur","aqsa","noor"]
...
// TASK 32
let current_users : string [] = ["dua","Aqsa","Noor","Bilal","Hassan","fajur"]
let new_users : string [] = ["dua","fajur","Inaaya","Hira","Arham","Aliya"]
...
//TASK 34
let favourite_pizza : string [] = ["Cheesy Garlic Pizza","Meat Pizza","BBQ Chicken Pizza"]
...
const magician: string[] = ["Fayyaz","Faraz","Faiz"];
...
const magicians2: string[] = ["Fayyaz","Faraz","Faiz"];
...
const magicians3: string[] = ["Fayyaz","Faraz","Faiz"];
...
const mycar: car = createCar("Volkswagen", "Jetta", { color: "black" , year: "2022"})
console.log(mycar);
